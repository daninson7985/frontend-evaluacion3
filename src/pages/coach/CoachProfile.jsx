  ...
  return (
    <Container>
      <div className="hero-section">
        <h1>Mi Perfil de Coach</h1>
        <p>Revisa tu perfil, especialidad y las clases que lideras.</p>
      </div>
            ...
            <Card className="shadow-sm">
              <Card.Body>
                ...
                <Card.Text>
                  ...
                  <br />
                  <strong>Especialidad:</strong> {profile?.metadata?.specialty || "No definida"}
                  <br />
          ...
          <Col md={6}>
            <Card className="shadow-sm">
              <Card.Body>
                ...
                <Card.Text>Ve tus clases activas, inscripciones y estado de asistencia.</Card.Text>
                <Button variant="success" size="sm" className="me-2" onClick={() => setShowModal(true)}>
                  Actualizar datos
                </Button>
                <Button as={Link} to="/coach/dashboard" className="btn-theme">
                  Volver al panel
                </Button>
              </Card.Body>
            </Card>
